  ...
  return (
    <div className="min-h-screen bg-[#070B14] pb-24">
      ...
      <div className="space-y-2">
        <p className="text-[9px] tracking-[0.2em] font-mono text-[#445577] uppercase font-bold">Account</p>
        ...
        >
          ...
          <div>
            ...
            <span className="text-xs text-[#445577]">Download all your data as JSON (GDPR)</span>
          </div>
        </button>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="bg-[#111827] border border-[#EF4444]/20 rounded-xl p-4 space-y-3">
          ...
          <p className="text-xs text-[#445577] leading-relaxed">
          ...
          <input
            ...
            className="w-full bg-[#0D1117] border border-[#1E2D40] rounded-lg px-3 py-2 text-sm text-[#F0F4FF] placeholder:text-[#445577] focus:outline-none focus:border-[#EF4444]/50"
          />
          <button
