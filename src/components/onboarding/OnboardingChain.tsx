    ...
    <button
      ...
      className={`w-full text-left px-4 py-3.5 rounded-xl border transition-all ${
        selected
          ...
          : 'bg-[#0D1117] border-[#1E2D40] hover:border-[#C9A84C]/30'
      }`}
    >
      <span className={`text-sm font-semibold ${selected ? 'text-[#C9A84C]' : 'text-[#F0F4FF]'}`}>
        {label}
      </span>
...
function NumIn({
  ...
  return (
    <input
      ...
      value={value}
      onChange={e => onChange(e.target.value)}
      className="w-full bg-[#0D1117] border border-[#1E2D40] rounded-xl px-4 py-3 text-sm text-[#F0F4FF] placeholder:text-[#445577] focus:border-[#C9A84C]/50 focus:outline-none transition-all"
    />
  );
}
...
function Q({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-sm font-semibold text-[#F0F4FF] mb-2 leading-relaxed">
      {children}
    </p>
  );
}
...
function Block({ children }: { children: React.ReactNode }) {
  return (
    <div className="bg-[#111827] border border-[#1E2D40] rounded-2xl p-4 space-y-2">
      {children}
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#070B14] pb-32">
      ...
      <div className="px-5 space-y-4">
        ...
        <div className="bg-[#111827] border border-[#F97316]/30 rounded-2xl p-4">
          <div className="flex items-start gap-3 mb-3">
            <Shield className="w-5 h-5 text-[#F97316] flex-shrink-0 mt-0.5" />
            <div>
              <p className="text-sm font-bold text-[#F0F4FF] mb-2">
                Before we begin
              </p>
              <p className="text-xs text-[#8899BB] leading-relaxed mb-2">
                King AI Coach provides personalized fitness and nutrition
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl border text-sm font-bold transition-all ${
              disclaimerAccepted
                ...
                : 'bg-[#0D1117] border-[#F97316]/30 text-[#F97316]'
            }`}
          >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#070B14]/95 backdrop-blur border-t border-[#1E2D40] px-5 py-4">
        <button
          onClick={onNext}
          disabled={!isComplete}
          className="w-full bg-[#C9A84C] hover:bg-[#E8C76A] disabled:opacity-30 text-black font-black py-4 rounded-2xl text-base transition-all flex items-center justify-center gap-2"
        >
          <span>Continue</span>
    ...
    <div className="min-h-screen bg-[#070B14] pb-32">
      ...
      <div className="px-5 space-y-4">
        ...
        <Block>
          ...
          {/* Gender */}
          <div className="mt-2">
            <label className="text-xs text-[#445577] mb-1.5 block">Gender</label>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#070B14]/95 backdrop-blur border-t border-[#1E2D40] px-5 py-4">
        <button
          ...
          className="w-full bg-[#C9A84C] hover:bg-[#E8C76A] disabled:opacity-30 text-black font-black py-4 rounded-2xl text-base transition-all"
        >
...
function GeneratingScreen({ name }: { name: string }) {
  return (
    <div className="min-h-screen bg-[#070B14] flex flex-col items-center justify-center px-5 text-center">
      ...
      <p className="text-sm text-[#8899BB] max-w-xs leading-relaxed mb-2">
      ...
      <p className="text-xs text-[#445577] max-w-xs leading-relaxed mb-8">
