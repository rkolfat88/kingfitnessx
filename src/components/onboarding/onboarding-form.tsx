...
export function OnboardingForm({ userId }: { userId: string }) {
  ...
  return (
    <div className="min-h-screen bg-black flex items-start justify-center pt-16 px-4 pb-8">
      <div className="w-full max-w-lg bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6">
        ...
        {/* Progress bar */}
        <div className="w-full h-1 bg-[var(--surface-3)] rounded-full mb-6">
          <div
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {step === 3 && (
            <div className="space-y-5 animate-[fadeIn_0.3s_ease-out]">
              <h2 className="text-lg font-semibold text-white">Your Primary Goal</h2>
